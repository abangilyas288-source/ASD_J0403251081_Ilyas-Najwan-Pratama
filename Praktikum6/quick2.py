...
def partition(data,first,last):
    ...
    while not done:
        ...
        while leftmark <= rightmark and data[leftmark] >= pivotvalue: # Descending menggunakan >=
            leftmark = leftmark + 1

        while data[rightmark] <= pivotvalue and rightmark >= leftmark: # Descending menggunakan <=
