...
def partition(data,first,last):
    ...
    while not done:
        ...
        while leftmark <= rightmark and data[leftmark] <= pivotvalue: # Ascending menggunakan <=
            leftmark = leftmark + 1

        while data[rightmark] >= pivotvalue and rightmark >= leftmark: # Ascending menggunakan >=
